              ...
              <tr>
                <td>
                  <h1 style="margin-bottom: 32px">
                    You’ve just sent a payment request!
                  </h1>
                  <h3 style="margin-bottom: 24px">
                    <span style="font-weight: normal">Dear</span> ${customerName},
                  </h3>
                  <p style="margin-bottom: 12px">
                    You have just sent a payment request to <strong>${contactName}</strong>. Please login to the app to
                    view and manage the request.
                  </p>
