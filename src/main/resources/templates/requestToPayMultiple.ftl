              ...
              <tr>
                <td>
                    ...
                    <table style="text-align: left; border: 1px solid #F59C1C; border-radius: 10px;">
                      ...
                      <tr>
                        <td
                          ...
                          Time</td>
                        <td style="padding: 5px 20px 20px; font-weight: 700; font-size: 16px; color: #313131;">${time}
                        </td>
                      </tr>
                    </table>
                    <#list recipients as recipient>
                      <table
                        style="text-align: left; margin: 20px 0 0; border: 1px solid #F59C1C; border-radius: 10px;">
                        <colgroup>
                          <col style="width: 35%" />
                          <col style="width: 65%" />
                        </colgroup>
                  ...
                  <#if segment=='ISLAMIC' || segment=='ISLAMIC_PRIVATE' || segment=='ISLAMIC_GOLD'>
                    ...
                    <#list recipients as recipient>
                      <table
                        style="text-align: left; margin: 20px 0 0; border: 1px solid #047B5F; border-radius: 10px;">
                        <colgroup>
                          <col style="width: 35%" />
                          <col style="width: 65%" />
                        </colgroup>
                  ...
                  <#if segment=='CONV_GOLD'>
                    ...
                    <#list recipients as recipient>
                      <table
                        style="text-align: left; margin: 20px 0 0; border: 1px solid #DAAA61; border-radius: 10px;">
                        <colgroup>
                          <col style="width: 35%" />
                          <col style="width: 65%" />
                        </colgroup>
                  ...
                  <#if segment=='CONV_PRIVATE'>
                    ...
                    <#list recipients as recipient>
                      <table
                        style="text-align: left; margin: 20px 0 0; border: 1px solid #CCCCCC; border-radius: 10px;">
                        <colgroup>
                          <col style="width: 35%" />
                          <col style="width: 65%" />
                        </colgroup>
