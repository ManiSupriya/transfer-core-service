              ...
              <tr>
                <td>
                  <h1 style="margin-bottom: 32px">
                    You’ve just received a payment!
                  </h1>
                  <h3 style="margin-bottom: 24px">
                    <span style="font-weight: normal">Dear</span> ${customerName},
                  </h3>
                  <p style="margin-bottom: 12px">
                    You have just received a payment from <strong>${contactName}</strong>. Please find the details below.
                  </p>
                  <table style="text-align: left;    border: 1px solid #D7D7D7;
                    ...
                    <tr>
                      <td style="padding: 5px 10px 5px 20px">To your account </td>
                      <td style="padding-left: 20px">${toAccount}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td style="padding: 5px 10px 20px 20px">Received from</td>
