                ...
                <td>
                  ...
                  <div class="ippDataContainer">
                    ...
                    <table style="border-collapse: collapse">
                      ...
                      <tr>
                        <td class="ippDataKeyFontStyle" style="padding: 20px 0 6px 20px;">Reason for failure</td>
                        <td class="ippDataValueFontStyle" style="padding: 20px 20px 6px 0;">
                          ${reasonForFailure}
                        </td>
                      </tr>
                      <tr style="border-bottom: 1px solid #F59C1C;">
                        <td class="ippDataKeyFontStyle" style="padding: 6px 0 20px 20px;">Next steps</td>
                        <td class="ippDataValueFontStyle" style="padding: 6px 20px 20px 0;">
                          ${alternateStepsIfAny}
                        </td>
                      </tr>
                    </table>
