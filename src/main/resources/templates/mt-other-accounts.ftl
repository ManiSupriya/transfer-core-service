      ...
      <tr>
        ...
        <td class="email-container bg_white">
          ...
          <p style="margin-bottom: 40px">
            <img
              src="https://contentdelivery.mashreqbank.com/channel/email_images/header-money-transfer-other-accounts.png"
              width="600" />
          </p>
          <!-- /hero -->
          <div class="content">
              ...
              <tr>
                <td>
                  ...
                  <ul style="list-style: circle; padding: 0px 19px;">
                    ...
                    <li style="margin-bottom: 16px">
                      <p><span style="min-width: 200px;display: inline-block;">From ${sourceOfFund}</span><span
          ...
          <table style="
            ...
            <tr>
              <td style="padding: 0; margin: 0">
                <img
                  src="https://contentdelivery.mashreqbank.com/channel/email_images/money-transfer-other-accounts-bottom-banner.png"
                  width="100%" alt="" />
              </td>
            </tr>
          </table>
            ...
            <tr>
              <td>
                <img src="https://contentdelivery.mashreqbank.com/common/small-logo/${segment}.png"
                  style="float: left; margin-right: 8px" width="46" alt="" />
                <span style="
                      margin-top: 4px;
                      font-size: 12px;
                      display: inline-block;
              ...
              <td style="text-align: right">
                ...
                <a href="${instagramLink}" style="
                      ...
                      display: inline-block;
                      margin-left: 16px;
                    "><img src="https://contentdelivery.mashreqbank.com/common/icons/instagram.png" width="18"
                    alt="" />
                </a>
