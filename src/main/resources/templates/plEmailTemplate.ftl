      ...
      <tr>
        ...
        <td class="email-container bg_white">
              ...
              <tr>
                <td>
                  <h1 style="margin-bottom: 32px">
                    Your ${transactionType} initiation request has been set.
                  </h1>
          ...
          <table>
              <tr>
                  <td>
                        <p style="margin-bottom: 40px"><img src="https://contentdelivery.mashreqbank.com/mbol/email/banner/quick_remit_info.png" width="600" /></p>
                  </td>
              </tr>
          </table>
          <div class="content">
