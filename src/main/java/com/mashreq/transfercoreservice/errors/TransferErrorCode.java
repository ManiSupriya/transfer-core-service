...
public enum TransferErrorCode implements ErrorCode {
    ...
    NSTP_LIMIT_REACHED("LM-2016", "NSTP Limit Increase Not available at the moment"),
    ...
    BANK_CHARGES_EXTERNAL_SERVICE_ERROR("TN-5021", "Something went wrong with bank charges external service"),
    ...
    FT_CC_NO_DEALS("TN-8008","Credit Card not allowed as a source of fund for this country/beneficiary. Please change the source of funds as account."),
    FT_CC_BALANCE_NOT_SUFFICIENT("TN-8009","Credit card limit is less than the transfer amount, please enter amount with in the available limit."),
