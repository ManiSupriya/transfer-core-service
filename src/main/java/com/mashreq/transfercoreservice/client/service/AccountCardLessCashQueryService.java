...
public class AccountCardLessCashQueryService implements CoreEnquiryService<List<CardLessCashQueryResponse>, String, Integer>{
	...
	@Override
	public Response<List<CardLessCashQueryResponse>> doCall(String p, Integer q) {
		return accountClient.cardLessCashRemitQuery(p, q);
	}
	@Override
