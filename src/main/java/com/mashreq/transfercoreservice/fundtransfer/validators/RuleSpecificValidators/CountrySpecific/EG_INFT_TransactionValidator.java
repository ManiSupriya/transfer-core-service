package com.mashreq.transfercoreservice.fundtransfer.validators.RuleSpecificValidators.CountrySpecific;
...
@Slf4j
@Component("EG_INFT_TransactionValidator")
public class EG_INFT_TransactionValidator implements Validator<RuleSpecificValidatorRequest> {
