...
//import com.mashreq.esbcore.bindings.customerservices.mbcdm.
...
//
//    public FlexRuleEngineDTO getBankDetailByIfscCode(final String channelTraceId, final FlexRuleEngineRequestDTO request) {
//        log.info("Flex Rule engine call initiated [ {} ]", request);
//
//        EAIServices response = (EAIServices) webServiceClient.exchange(generateFlexRuleEngineRequest(channelTraceId, ifscCode));
...
//    }
//
//    private EAIServices generateFlexRuleEngineRequest(String channelTraceId, String ifscCode) {
