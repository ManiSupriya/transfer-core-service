...
//        validateContext.add("src-country-iso", srcCountryIso);
        ...
        final QuickRemitFundTransfer quickRemitFundTransfer = fundTransferStrategies.get(getServiceByCountry("NP"));

        return quickRemitFundTransfer.execute(request, metadata, userDTO, null);
    }
