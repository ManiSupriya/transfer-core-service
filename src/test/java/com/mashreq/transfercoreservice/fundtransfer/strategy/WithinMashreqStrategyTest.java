...
public class WithinMashreqStrategyTest implements FundTransferStrategy {
    ...
    public FundTransferResponse execute(FundTransferRequestDTO request, RequestMetaData metadata, UserDTO userDTO) {
        ...
        if(isSuccessOrProcessing(fundTransferResponse)) {
            ...
            notificationService.sendNotifications(customerNotification,NotificationType.OTHER_ACCOUNT_TRANSACTION,metadata,userDTO, NotificationName.WITHIN_MASHREQ_FT);
